            ...
            if($(".datatable").length > 0){                
                $(".datatable").dataTable({
                    "language": {
                        ...
                        "sLengthMenu":   "<span style='font-weight:bolder;font-size:15px;'>أظهر _MENU_ مدخلات</span>",
                        "sZeroRecords":  "<span style='font-weight:bolder;'>لم يعثر على أية سجلات</span>",
                        "sInfo":         "إظهار _START_ إلى _END_ من أصل _TOTAL_ مدخل",
                        "sInfoEmpty":    "يعرض 0 إلى 0 من أصل 0 سجل",
                        "sInfoFiltered": "(منتقاة من مجموع _MAX_ مُدخل)",
                        "sInfoPostFix":  "",
                        "sSearch":       "<span style='font-weight:bolder;font-size:15px;'>ابحث </span>: ",
                        "sUrl":          "",
                        "oPaginate": {
                            "sFirst":    "الأول",
                            "sPrevious": "السابق",
