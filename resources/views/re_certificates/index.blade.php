...
@section('title') {{trans('strings.teachers')}} - {{trans('strings.Qualifications & certificates')}}
@endsection
...
@section('contents')
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{trans('strings.teachers')}} - {{trans('strings.Qualifications & certificates')}}</li>
                    <li style="color: green;"><span class="fa fa-users"></span>{{trans('strings.cer_count')}} ({{$certificates->count()}})</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="{{url('re_certificates/certificates/print/')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="submit" class="btn btn-success btn-block" id="all-print"><span class="fa fa-print"></span> {{trans('strings.print')}} {{trans("strings.Qualifications & certificates")}}</button>
                                            </div>
                                        </div>
