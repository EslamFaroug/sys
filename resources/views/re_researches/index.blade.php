...
@section('title') {{trans('strings.Scientific Research')}}
@endsection
...
@section('contents')
    <script>
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{trans('strings.teachers')}} - {{trans('strings.Scientific Research')}}</li>
                    <li style="color: green;"><span class="fa fa-users"></span> {{trans('strings.researche_count')}} ({{$researches->count()}})</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="{{url('re_researches/print/researches')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                    ...
                                                    <select id="filter" name="filter" class="form-control" >
                                                        <optgroup  label="{{trans('strings.sort_by')}}">
                                                            ...
                                                            <option value="researche">{{trans('strings.res_delete')}}</option>
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;"   id="titleFilter">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="title" name="title" class="form-control" placeholder="{{trans('strings.research-input-label')}}"/>
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="submit" class="btn btn-success btn-block" id="all-print"><span class="fa fa-print"></span> {{trans('strings.print')}} {{trans("strings.Scientific Research")}}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
