...
@section('title') {{trans('strings.teachers')}} - {{trans('strings.Skills and activities')}}
@endsection
...
@section('contents')
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{trans('strings.teachers')}} - {{trans('strings.Skills and activities')}}</li>
                    <li style="color: green;"><span class="fa fa-users"></span>{{trans('strings.skill_count')}} ({{$skills->count()}})</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="{{url('re_skills/skills/print/')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="submit" class="btn btn-success btn-block" id="all-print"><span class="fa fa-print"></span> {{trans('strings.print')}} {{trans("strings.Skills and activities")}}</button>
                                            </div>
                                        </div>
