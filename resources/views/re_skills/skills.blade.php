...
@section('title'){{trans('strings.print')}} {{trans("strings.teachers")}} - {{trans('strings.Skills and activities')}}
@endsection
...
@section("content")
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="" style="text-align: center"> {{trans('strings.Skills and activities')}} - {{trans('teacher.teachers')}}
        ...
        <div class="panel-body">
            <table class="table datatable">
                ...
                @foreach($skills as $skill)
                    <tr>
                        <td>{{$loop -> index+1}}</td>
                        <td>@if($skill->teacher_ar_name) {{$skill->teacher_ar_name}} @else {{$skill->teachers->ar_name}}  @endif</td>
                        <td>{{$skill -> name}}</td>
