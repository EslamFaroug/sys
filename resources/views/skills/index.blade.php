          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"> {{trans('strings.add-new')}} : {{trans('strings.upd_skill')}}</h5>
                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td>{{$loop -> index+1}}</td>
                                               <td>{{$skill->teachers->ar_name}}</td>
                                                <td>{{$skill -> name}}</td>
                                                <td>{{$skill -> decription}}</td>
                                                <td>
                                                <button onclick='update_degrees(this.id)' id="{{$skill->skill_id}}" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span>  {{trans('strings.update')}} </button> 
                                                <button 
