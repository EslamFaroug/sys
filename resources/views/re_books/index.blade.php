...
@section('title') {{trans('strings.Books')}}
@endsection
...
@section('contents')
    <script>
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{trans('strings.teachers')}} - {{trans('strings.Books')}}</li>
                    <li style="color: green;"><span class="fa fa-users"></span> {{trans('strings.book_count')}} ({{$books->count()}})</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="{{url('re_books/print/books')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                    ...
                                                    <select id="filter" name="filter" class="form-control" >
                                                        <optgroup  label="{{trans('strings.sort_by')}}">
                                                            ...
                                                            <option value="book">{{trans('strings.upd_book')}}</option>
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;"   id="titleFilter">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="title" name="title" class="form-control" placeholder="{{trans('strings.book-input-label')}}"/>
                                            ...
                                            <div class="col-md-3" style="display: none; margin-top: 5px;"   id="publisherFilter">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="publisher" name="publisher" class="form-control" placeholder="{{trans('strings.book_publisher')}}"/>
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="submit" class="btn btn-success btn-block" id="all-print"><span class="fa fa-print"></span> {{trans('strings.print')}} {{trans("strings.Books")}}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
