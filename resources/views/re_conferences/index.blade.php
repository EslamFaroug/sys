...
@section('title') {{trans('strings.Conferences and meetings')}}
@endsection
...
@section('contents')
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{trans('strings.teachers')}} - {{trans('strings.Conferences and meetings')}}</li>
                    <li style="color: green;"><span class="fa fa-users"></span> {{trans('strings.conference_count')}} ({{$conferences->count()}})</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="{{url('re_conferences/conferences/print')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                    ...
                                                    <select id="filter" name="filter" class="form-control" >
                                                        <optgroup  label="{{trans('strings.sort_by')}}">
                                                            ...
                                                            <option value="conference">{{trans('strings.conf_nane')}}</option>
                                                        <option value="univ_title">{{trans('strings.univ_title')}}</option>
                                                            <option value="degree">{{trans('strings.degree_name')}}</option>
                                                            <option value="country">{{trans('strings.select_country')}}</option>
                                                        </optgroup>
                                                    </select>
                                            ...
                                            <div class="col-md-3" style="display: none; margin-top: 5px;" id="universityFilter">
                                                <div class="input-group">
                                                    ...
                                                    <select  id="universitySelect" class="form-control js-specials" type="text" name="university_id">
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;"   id="titleFilter">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="title" name="title" class="form-control" placeholder="{{trans('strings.conf_nane')}}"/>

                                                </div>
                                            </div>
                                            <div class="col-md-3" style="display: none; margin-top: 5px;"   id="publisherFilter">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <span class="fa fa-search"></span>
                                                    </div>
                                                    <input type="text" id="publisher" name="publisher" class="form-control" placeholder="{{trans('strings.conference_publisher')}}"/>
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="submit" class="btn btn-success btn-block" id="all-print"><span class="fa fa-print"></span> {{trans('strings.print')}} {{trans("strings.Conferences and meetings")}}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
