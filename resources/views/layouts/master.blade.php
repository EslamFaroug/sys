...
<head>
    ...
    <!-- animation CSS -->
    <link href="/horizontal-rtl/css/animate.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="/horizontal-rtl/css/style.css" rel="stylesheet">
    <!-- color CSS -->
    <link href="/horizontal-rtl/css/colors/blue-dark.css" id="theme" rel="stylesheet">
...
<body class="fix-header">
    ...
    <script src="/horizontal-rtl/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="/horizontal-rtl/js/waves.js"></script>
    <!--Counter js -->
    ...
    <script src="/horizontal-rtl/js/custom.min.js"></script>
    <script src="/horizontal-rtl/js/dashboard1.js"></script>
    <!-- Custom tab JavaScript -->
    <script src="/horizontal-rtl/js/cbpFWTabs.js"></script>
