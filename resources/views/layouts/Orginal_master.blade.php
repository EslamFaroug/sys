...
<!-- Mirrored from owwwlab.com/faculty/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 14:24:37 GMT -->
...
<link href="{{ asset('css/app.css') }}" rel="stylesheet">
        ...
        <link rel="stylesheet" href="{{('/profile/css/perfect-scrollbar-0.4.5.min.css')}}">
        <link rel="stylesheet" href="{{('/profile/css/magnific-popup.css')}}">
        <link rel="stylesheet" href="{{('/profile/css/style.css')}}">
        <link id="theme-style" rel="stylesheet" href="{{('/profile/css/styles/default.css')}}">

        
        <!--/CSS styles-->
        <!--Javascript files-->
        <script type="text/javascript" src="{{('/profile/js/jquery-1.10.2.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/TweenMax.min.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/jquery.touchSwipe.min.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/jquery.carouFredSel-6.2.1-packed.js')}}"></script>
        
        <script type="text/javascript" src="{{('/profile/js/modernizr.custom.63321.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/jquery.dropdownit.js')}}"></script>

        <script type="text/javascript" src="{{('/profile/js/jquery.stellar.min.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/ScrollToPlugin.min.js')}}"></script>

        <script type="text/javascript" src="{{('/profile/js/bootstrap.min.js')}}"></script>

        <script type="text/javascript" src="{{('/profile/js/jquery.mixitup.min.js')}}"></script>

        <script type="text/javascript" src="{{('/profile/js/masonry.min.js')}}"></script>

        <script type="text/javascript" src="{{('/profile/js/perfect-scrollbar-0.4.5.with-mousewheel.min.js')}}"></script>
        <script type="text/javascript" src="{{('/profile/js/magnific-popup.js')}}"></script>
        ...
        <link rel="stylesheet" href="{{('/profile/custom-style.css')}}">
        <script type="text/javascript" src="{{('/profile/custom-style.js')}}"></script>
        <!--/Custom Styles-->
         <style type="text/css">
            @yield('style')
        </style>                                    
                        ...
                        <ul id="navigation">
                            ...
                            <li class="external">
                              <a href="#">
                                  ...
                                  <div class="text">{{trans('profile.Download CV')}}</div>
                              </a>
                            </li>
                            <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link" href="/lang">
                            <span class="text-center fa fa-globe">
                            </span> &nbsp;&nbsp;{{trans('strings.language')}}
                            </a>                        
                            </li>
                        </ul>
                    </div>        
                            ...
                            <div class="section-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-md-5">
                                        <div class="biothumb">
                                            <img alt="image" src="/profile/img/personal/06.jpg"  class="img-responsive">
                                            <div class="overlay">
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li class="open">
                                                ...
                                                <div class="data">
                                                    ...
                                                    <div class="text row">
                                                        <div class="col-md-2">
                                                            <img alt="image" class="thumbnail img-responsive" src="/profile/img/Nobel_Prize.png" >
                                                        </div>
                                                        <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div id="labp-heads-wrap">
                                            ...
                                            <div id="lab-carousel">
                                                <div><img alt="image" src="/profile/img/lab/lab5.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                                <div><img alt="image" src="/profile/img/lab/lab2.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                                <div><img alt="image" src="/profile/img/lab/lab1.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                                <div><img alt="image" src="/profile/img/lab/lab4.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                                <div><img alt="image" src="/profile/img/lab/lab3.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                                <div><img alt="image" src="/profile/img/lab/lab6.jpg" width="120" height="120" class="img-circle lab-img" /></div>
                                            </div>
                                            <div>
                                        ...
                                        <ul class="ul-withdetails">
                                            <li>
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-3">
                                                        <div class="image">
                                                            <img alt="image" src="/profile/img/projects/p3.jpg"  class="img-responsive">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-3">
                                                        <div class="image">
                                                            <img alt="image" src="/profile/img/projects/p2.jpg"  class="img-responsive">
                                                            <div class="imageoverlay">
                                                                <i class="icon icon-search"></i>
                                                            </div>
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-3">
                                                        <div class="image">
                                                            <img alt="image" src="/profile/img/projects/p4.jpg"  class="img-responsive">
                                                            <div class="imageoverlay">
                                                                <i class="icon icon-search"></i>
                                                            </div>
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-3">
                                                        <div class="image">
                                                            <img alt="image" src="/profile/img/projects/p5.jpg"  class="img-responsive">
                                                            <div class="imageoverlay">
                                                                <i class="icon icon-search"></i>
                                                            </div>
                        ...
                        <div class="section color-3" id="gallery-large">
                            <div class="section-container">
                                ...
                                <ul id="grid" class="grid">
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/06.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/02.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/03.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/04.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/05.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/01.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/07.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/08.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/09.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/10.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/11.jpg">
                                    ...
                                    <li>
                                        <div>
                                            <img alt="image" src="/profile/img/gallery/12.jpg">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                <span><a href="http://owwwlab.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f19b959e94b18285909f979e8395df949584">[email&#160;protected]</a></span>
                                            </li>
                                            <li>
                                                <strong><i class="icon-envelope"></i>&nbsp;&nbsp;</strong>
                                                <span><a href="http://owwwlab.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2d474942486d4a404c4441034e4240">[email&#160;protected]</a></span>
                                            </li>
                                            <li>
...
<!-- Mirrored from owwwlab.com/faculty/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 14:26:29 GMT -->
</html>